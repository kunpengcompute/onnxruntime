...
2. 下载并应用Patch。
   ...
   ```bash
   git clone --branch dev_for_26930 https://gitcode.com/boostkit/onnxruntime.git kp_onnxruntime
   cd onnxruntime
   git apply ../kp_onnxruntime/docs/docs_for_26930/patches/001-boostsra-onnxruntime-1.0.0-graph-optimization.patch
   git apply ../kp_onnxruntime/docs/docs_for_26930/patches/002-boostsra-onnxruntime-1.0.0-parallel-executor.patch
   ```
3. 编译安装
